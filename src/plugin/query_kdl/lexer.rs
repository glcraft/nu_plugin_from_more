...
mod lexer_tests {
    ...
    fn token_brackets() {
        ...
        assert_eq!(lexer.next(), Some(TokenType::Slash));
        assert_eq!(lexer.next(), Some(TokenType::EnterBracket));
        assert_eq!(lexer.next(), Some(TokenType::Alphanumeric("a")));
        assert_eq!(lexer.next(), Some(TokenType::Comma));
        assert_eq!(lexer.next(), Some(TokenType::Alphanumeric("b")));
        assert_eq!(lexer.next(), Some(TokenType::LeaveBracket));
        assert_eq!(lexer.next(), None);
    }
